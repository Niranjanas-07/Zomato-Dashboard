...
This repository contains the **Zomato Data Analysis Dashboard** created using **Power BI Desktop**.  
The dashboard provides insights into restaurant data, including ratings, cuisines, locations, and pricing trends.
...
- No Power BI account is required to view the dashboard locally.  

---

**Created by:** Niranjana S 
